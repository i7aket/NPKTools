...
namespace SYT.NPKTools.Benchmarks;
...
public class SolverBenchmarks
{
    ...
    public int Simplex()
    {
        FertilizerSolutions result = _simplexService.FindSolutions(_target);
    ...
    public int OrTools()
    {
        FertilizerSolutions result = _orToolsService.FindSolutions(_target);
        return result.Macro.Count + result.Micro.Count;
    }
