...
using static SYT.NPKTools.Internal.Labels;
...
public static class FertilizerExtensions
{
    ...
    public static string Report(this Fertilizer fertilizer)
    {
        ...
        // Qualified because the Labels constant and the ConcentrateType enum now share a namespace.
        stringBuilder.AppendLine(CultureInfo.InvariantCulture, $"{Labels.ConcentrateType}: {fertilizer.Type}");
